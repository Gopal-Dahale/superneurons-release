...
int main(int argc, char **argv) {
    ...
    train_mean_file = (char *) "../bin_cifar_data/cifar_train.mean";
    train_image_bin = (char *) "../bin_cifar_data/cifar10_train_image_0.bin";
    train_label_bin = (char *) "../bin_cifar_data/cifar10_train_label_0.bin";
    test_image_bin  = (char *) "../bin_cifar_data/cifar10_test_image_0.bin";
    test_label_bin  = (char *) "../bin_cifar_data/cifar10_test_label_0.bin";
